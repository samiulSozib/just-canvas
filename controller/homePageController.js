...
exports.getHomePage = async(req, res, next) => {
    try {
        ...
        if (req.user.role == '2') {
            ...
            return res.render('pages/admin/admin_homepage', { title: 'Admin Homepage', user: req.user })
        } else if (req.user.role == '4') {
            return res.render('pages/admin/editor_homepage', { title: 'Editor Homepage', user: req.user })
        }
    } catch (e) {
        console.log(e)
    }
